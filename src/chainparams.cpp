...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("b74ae58b45f0cbf6f78cce39c0233008d38251ae3f66a780d349e7a1e05a9504");
        ...
        consensus.defaultAssumeValid = uint256S("0xb74ae58b45f0cbf6f78cce39c0233008d38251ae3f66a780d349e7a1e05a9504"); //1683528
        ...
        genesis = CreateGenesisBlock(1576731416, 1376428, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xb74ae58b45f0cbf6f78cce39c0233008d38251ae3f66a780d349e7a1e05a9504"));
        assert(genesis.hashMerkleRoot == uint256S("0x1a1ecf71ce7d0c2192abacf23e3ddeb282c256b519ec571d8d0d8fd733386663"));
        ...
        //vSeeds.emplace_back("seed-a.faxtcoin.loshan.co.uk");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.faxtcointools.com");
        //vSeeds.emplace_back("dnsseed.faxtcoinpool.org");
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x8adedbbd66f7a3b0c9de315980e5355689f21810fdec03ed2047ca1eb823a10a"); //1174621
        ...
        genesis = CreateGenesisBlock(1486949366, 96217, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x8adedbbd66f7a3b0c9de315980e5355689f21810fdec03ed2047ca1eb823a10a"));
        assert(genesis.hashMerkleRoot == uint256S("0x1a1ecf71ce7d0c2192abacf23e3ddeb282c256b519ec571d8d0d8fd733386663"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        //vSeeds.emplace_back("testnet-seed.faxtcointools.com");
        //vSeeds.emplace_back("seed-b.faxtcoin.loshan.co.uk");
        //vSeeds.emplace_back("dnsseed-testnet.thrasher.io");

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,111);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,196);
        base58Prefixes[SCRIPT_ADDRESS2] = std::vector<unsigned char>(1,88);
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xb08447785d683d714c4c791fea593c76f6742afe955b3c36bed5b56bf4709758"));
        assert(genesis.hashMerkleRoot == uint256S("0x1a1ecf71ce7d0c2192abacf23e3ddeb282c256b519ec571d8d0d8fd733386663"));
