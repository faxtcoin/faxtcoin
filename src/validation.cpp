...
#if defined(NDEBUG)
# error "Faxtcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Faxtcoin Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache, bool test_accept) EXCLUSIVE_LOCKS_REQUIRED(cs_main)
{
...

    {
        ...
        for (CTxMemPool::txiter it : allConflicting)
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s FAXT additional fees, %d delta bytes\n",
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    if (nHeight == 1) return COIN * 80000000000;
...
void ThreadScriptCheck() {
    RenameThread("faxtcoin-scriptch");
