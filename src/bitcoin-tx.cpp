...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " faxtcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  faxtcoin-tx [options] <hex-tx> [commands]  Update hex-encoded faxtcoin transaction\n" +
            "or:     faxtcoin-tx [options] -create [commands]   Create hex-encoded faxtcoin transaction\n" +
            "\n";
