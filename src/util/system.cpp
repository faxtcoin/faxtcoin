...
const char * const BITCOIN_CONF_FILENAME = "faxtcoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Faxtcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Faxtcoin";
#else
    // Unix
    return pathRet / ".faxtcoin";
#endif
#endif
}
