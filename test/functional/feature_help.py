...
"""Verify that starting faxtcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start faxtcoin with -h for help text")
        ...
        self.log.info("Start faxtcoin with -version for version information")
        ...
        self.log.info("Start faxtcoind with -fakearg to make sure it does not start")
