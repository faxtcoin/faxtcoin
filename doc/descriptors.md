# Support for Output Descriptors in Faxtcoin Core

Since Faxtcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Faxtcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Faxtcoin Core wallets, a convenience function `combo` is
